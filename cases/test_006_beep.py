...
def test_beep_up():
    subprocess.run("ansible {} -m shell -a 'i2cset -f -y 0 0x64 0x8 0xf9'".format(board_model), shell=True,
...
def test_beep_down():
    ret = subprocess.run("ansible {} -m shell -a 'i2cset -f -y 0 0x64 0x8 0xf8'".format(board_model),
